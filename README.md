...
**Key Features:**
- Token swapping via Automated Market Maker (AMM)
- Built-in widget components
- Simplified protocol interaction methods

**GitHub Repository:**  
https://github.com/rhea-finance/rhea-sdk
...
**Key Features:**
- Unified lending operations across multiple blockchains
- Support for EVM chains, Solana, Bitcoin, ZEC, and NEAR
- Cross-chain interoperability

**GitHub Repository:**  
https://github.com/rhea-finance/cross-chain-sdk

**Demo:**
- **GitHub Repository:** https://github.com/rhea-finance/cross-chain-demo
- **Live Demo:** https://sdkdemo.rhea.finance
...
**Key Features:**
- Complete HTTP API for lending data retrieval
- Support for all lending data operations
- RESTful API design

**GitHub Repository:**
https://github.com/rhea-finance/burrow-sdk-python
